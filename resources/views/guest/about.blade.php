        ...
        <div class="row ">
          <div class="col-md-4">
            <div class="post-entry">
              <img src="{{ asset('guest/images/person_1.jpg') }}" alt="Image placeholder" class="img-fluid">
              <div class="body-text">
          ...
          <div class="col-md-4">
            <div class="post-entry">
              <img src="{{ asset('guest/images/person_2.jpg') }}" alt="Image placeholder" class="img-fluid">
              <div class="body-text">
                <div class="category">Staff</div>
          ...
          <div class="col-md-4">
            <div class="post-entry">
              <img src="{{ asset('guest/images/person_3.jpg') }}" alt="Image placeholder" class="img-fluid">
              <div class="body-text">
