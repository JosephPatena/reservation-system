...
@section('content')
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-bookmark"></i>Cancellation Request</a></li>
                ...
                <tbody>
                  @foreach($reservations as $key => $reservation)
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="btn-group">
                          <button class="btn btn-success btn-sm set-status" style="cursor: pointer;" data-id="{{ encrypt($reservation->id) }}" data-status_id="{{ encrypt(2) }}" data-toggle="modal" data-target="#confirm"><i class="fa fa-check-circle"></i>&nbsp;&nbsp;Approve</button>
                        </div>
                      </td>
                    </tr>
                  @endforeach
